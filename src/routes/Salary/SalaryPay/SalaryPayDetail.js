...
import salaryWaitDetailStyle from './SalaryPayDetail.less';
...
@Form.create()
export default class SalaryPayDetail extends PureComponent {
  state={
    currentTab:"3",
  ...
  renderSalaryDetail = ()=>{
    ...
    return(<table className={salaryWaitDetailStyle.payroll__table}>
      {
  ...
  render() {
    ...
    return (
        <Card bordered={false}>
          ...
          {/*搜索栏*/}
          <Form onSubmit={this.handleSearch} layout="inline" style={{marginBottom:'15px'}}>
            <Row>
              <Col>
